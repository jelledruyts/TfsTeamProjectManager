...
namespace TeamProjectManager.Modules.WorkItemTypes
{
    public static class WorkItemTypeComparer
    {
        ...
        private static readonly string[] SystemFieldsWithReportableDimension = new string[] { "System.AreaPath", "System.AssignedTo", "System.ChangedBy", "System.ChangedDate", "System.CreatedBy", "System.CreatedDate", "System.Id", "System.IterationPath", "System.Reason", "System.State", "System.Title", "Microsoft.VSTS.Common.Severity", "Microsoft.VSTS.Common.StateChangeDate", "System.AuthorizedAs", "System.NodeName" };
        private static readonly string[] SystemFieldsWithReportableDetail = new string[] { "System.RevisedDate" };
        private static readonly string[] SystemFieldsWithReportableMeasure = new string[] { "System.AttachedFileCount", "System.ExternalLinkCount", "System.HyperLinkCount" };
        private static readonly string[] SystemFieldsWithSyncNameChanges = new string[] { "System.AuthorizedAs", "Microsoft.VSTS.Common.ActivatedBy", "Microsoft.VSTS.Common.ClosedBy", "Microsoft.VSTS.Common.ResolvedBy", "System.AssignedTo", "System.ChangedBy", "System.CreatedBy" };
        private static readonly string[] SystemFieldsWithFormulaSum = new string[] { "Microsoft.VSTS.Scheduling.OriginalEstimate", "Microsoft.VSTS.Scheduling.StoryPoints", "Microsoft.VSTS.Scheduling.CompletedWork", "Microsoft.VSTS.Scheduling.RemainingWork", "Microsoft.VSTS.Scheduling.BaselineWork", "System.AttachedFileCount", "System.ExternalLinkCount", "System.HyperLinkCount" };
        private static readonly string[] SystemFieldsWithNamesToRemoveSpaces = new string[] { "Microsoft.VSTS.TCM.ReproSteps", "System.AreaId", "System.AttachedFileCount", "System.ExternalLinkCount", "System.HyperLinkCount", "System.IterationId", "System.RelatedLinkCount", "Microsoft.VSTS.TCM.AutomatedTestId", "Microsoft.VSTS.TCM.AutomatedTestName", "Microsoft.VSTS.TCM.AutomatedTestStorage", "Microsoft.VSTS.TCM.AutomatedTestType", "Microsoft.VSTS.TCM.LocalDataSource" };
        private static readonly string[] FieldRuleElementNames = new string[] { "WHEN", "WHENCHANGED", "WHENNOT", "WHENNOTCHANGED" };
        private static readonly Dictionary<string, Dictionary<string, string>> SystemFieldsAutoGenerated = new Dictionary<string, Dictionary<string, string>>
        {
        ...
        private static void Normalize(XmlDocument root)
        {
            ...
            foreach (XmlAttribute closedInErrorAttribute in root.SelectNodes("//DEFAULTREASON[@value='Overtaken by events']/@value | //REASON[@value='Overtaken by events']/@value"))
            {
                closedInErrorAttribute.Value = "Overtaken by Events";
            }
            ...
            foreach (var refname in SystemFieldsAutoGenerated.Keys)
            {
                ...
                if (field == null)
                {
                    ...
                    foreach (var attributeEntry in SystemFieldsAutoGenerated[refname])
                    {
            ...
            foreach (XmlElement field in root.SelectNodes("//WORKITEMTYPE/FIELDS/FIELD"))
            {
                ...
                SetAttributeIfNeeded(field, refname, SystemFieldsWithReportableDimension, "reportable", "dimension");
                SetAttributeIfNeeded(field, refname, SystemFieldsWithReportableDetail, "reportable", "detail");
                SetAttributeIfNeeded(field, refname, SystemFieldsWithReportableMeasure, "reportable", "measure");
                SetAttributeIfNeeded(field, refname, SystemFieldsWithSyncNameChanges, "syncnamechanges", "true");
                SetAttributeIfNeeded(field, refname, SystemFieldsWithFormulaSum, "formula", "sum");
                ...
                if (SystemFieldsWithNamesToRemoveSpaces.Contains(refname))
                {
            ...
            foreach (XmlNode stateFieldsNode in root.SelectNodes("//WORKITEMTYPE/WORKFLOW/TRANSITIONS/TRANSITION/FIELDS"))
            {
                SortChildNodes(stateFieldsNode, n => GetValue(n.Attributes["refname"]));
            }
