...
namespace TeamProjectManager.Modules.BuildProcessTemplates
{
    ...
    {
        public static IEnumerable<BuildProcessTemplateInfo> GetBuildProcessTemplates(ApplicationTask task, Uri projectCollectionUri, IEnumerable<string> teamProjectNames)
        {
        ...
        public static void RegisterBuildProcessTemplate(ApplicationTask task, Uri projectCollectionUri, IEnumerable<string> teamProjectNames, string templateServerPath, ProcessTemplateType templateType, bool registerIfTemplateDoesNotExist, bool unregisterAllOtherTemplates, bool unregisterAllOtherTemplatesIncludesUpgradeTemplate, bool simulate)
        {
            using (var tfs = TfsTeamProjectCollectionFactory.GetTeamProjectCollection(projectCollectionUri))
            {
                var step = 0;
