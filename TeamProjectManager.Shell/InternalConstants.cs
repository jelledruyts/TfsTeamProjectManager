...
namespace TeamProjectManager.Shell
{
    ...
    {
        public const string AssemblyVersion = "2.3.*"; // This can be updated anytime as long as .NET user settings are not used (otherwise the settings directory depends on this version).
